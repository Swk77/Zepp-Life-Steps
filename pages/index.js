    ...
    <div className={`app-container ${darkMode ? 'dark-mode' : ''}`}>
      ...
      <div className="app-content">
        ...
        <div className="action-buttons">
          <Button 
            icon={<GithubOutlined />} 
            href="https://github.com/Swk77/Zepp-Life-Steps" 
            target="_blank"
            className="glass-button-secondary"
          >
            GitHub
        ...
        <div className="glass-footer">
          <div className="copyright">
            ...
            <Text type="secondary">
              Powered By <Link href="mqqapi://card/show_pslcard?src_type=internal&version=1&uin=2940714815&card_type=person&source=qrcode" target="_blank">Swk</Link>
            </Text>
          </div>
        </div>
      </div>
